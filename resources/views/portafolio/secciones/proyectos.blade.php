<section id="proyectos" class="scroll-mt-24 bg-superficie py-20 sm:py-24">
    <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        <div class="max-w-3xl">
            ...
            <p class="mt-4 text-lg leading-8 text-tinta-600">Experiencias presentadas sin datos sensibles, enfocadas en el problema, la solución y mi aporte.</p>
        </div>
        ...
        <div class="mt-12 grid gap-6 lg:grid-cols-2">
            @foreach ($portafolio['proyectos'] as $proyecto)
                <article class="flex flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
                    <h3 class="text-xl font-bold text-tinta-950 sm:text-2xl">{{ $proyecto['nombre'] }}</h3>
